    ...
    public class QuantriController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var quantri = await _context.Quantri
                .FirstOrDefaultAsync(m => m.QtMa == id);
            if (quantri == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("QtMa,QtEmail,QtMatkhau")] Quantri quantri)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("QtMa,QtEmail,QtMatkhau")] Quantri quantri)
        {
            if (id != quantri.QtMa)
            {
                return NotFound();
        ...
        {
            return _context.Quantri.Any(e => e.QtMa == id);
        }
    }
}
